...
const MenuGroup = forwardRef<HTMLButtonElement, MenuGroupProps>(
  ({ menu, isMobile = false, dropdown, setDropdown, closeMenu }, forwardedRef: Ref<HTMLButtonElement>) => {
    ...
    useEffect(() => {
      const handleClickOutside = (e: MouseEvent) => {
        if (
          ...
          !localButtonRef.current?.contains(e.target as Node)
        ) {
          setOpen(false);
        }
      };
