...
const HistoryPage: React.FC = () => {
  return (
    <div className="px-6 py-0 md:p-0 text-black font-sans">
      <ScreenInfoOverlay />
      <SEO
        title="HistoryPage – Maidenhead Town Bowls Club"
        description="A short history of the club."
      />
      <main className="bg-white/80 p-4 md:p-4 rounded-md shadow-lg max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          <img
            ...
            className="
              rounded shadow-md h-auto
              md:float-right md:w-1/3 md:ml-6 md:mb-4
              w-full
            "
          />
          ...
          <p className="mb-4">
            ...
            <Link to="/presidents" className="text-blue-700 underline hover:text-blue-900">
